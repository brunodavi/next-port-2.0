...
const components = {
    ...
    p: (props: any) => <p className="my-2 [&>*]:inline-block [&>*]:align-baseline [&>*]:mx-1" {...props} />,
    a: (props: any) => <a className="text-blue-500 hover:underline" {...props} />,
    ul: (props: any) => <ul className="list-disc my-2 ml-5" {...props} />,
    ol: (props: any) => <ol className="list-decimal my-2 ml-5" {...props} />,
    li: (props: any) => <li className="my-2 [&>*]:inline [&>*]:mx-1" {...props} />,
